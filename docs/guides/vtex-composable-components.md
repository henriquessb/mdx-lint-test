...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="https://vtex.com/us-en/vtex-personal-shopper/">VTEX Personal Shopper</a> is an app used by sales associates that brings the physical store
    ...
    <tr>
      ...
      <td>
        <a href="https://help.vtex.com/pt/tracks/suiteshare--khP0p8mjIYRIpvM7Cb4Zr">Assisted Sales (SuiteShare)</a>, previously known as Conversational Commerce, is a marketing platform
        ...
        The solution is based on the<a href="https://developers.facebook.com/docs/whatsapp/cloud-api">official WhatsApp API</a>.
      </td>
      <td>Plug-and-play, upon subscription/additional costs</td>
    </tr>
    <tr>
      <td>Pick and Pack</td>
      <td>
        <a href="https://help.vtex.com/en/tutorial/vtex-pick-and-pack--1OOops3WrUyz7e0bnhkfXU">VTEX Pick and Pack</a> helps merchants manage the order fulfillment process, including picking,
    ...
    <tr>
      <td>VTEX Shield</td>
      <td>
        <a href="https://help.vtex.com/en/tutorial/vtex-shield--2CVk6H9eY2CBtHjtDI7BFh">VTEX Shield</a> offers additional, customizable protection layers for stores
    ...
    <tr>
      <td>Ad Network</td>
      <td>
        <a href="https://help.vtex.com/en/tutorial/vtex-ad-network-beta--2cgqXcBuJmXN2livQvClur">VTEX Ad Network</a> connects VTEX stores with brands interested in advertising their
